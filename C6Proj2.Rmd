...
I used a for loop to run teh rexp function to calulcate 40 sample size simulation.  I ran this 1000 times and added the means to a data table.
```{r simulation }
  set.seed(8534)
  rate<-0.2
  n<-40
...
# 3 Now to compare sample variance & mean to the theoretical variance & mean, as well as review confidance levels
...
# 4 Distributions
Let's look at the distribution to show it is normal.  Seen below the green curve appears symmetric bell shaped, with ~68% of the values with in 1 standard deviation.

**Plot Code**
```{r plotMeans, echo=TRUE}
